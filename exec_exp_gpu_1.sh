...
echo "CUDA_VISIBLE_DEVICES=1 poetry run python src/run_experiment.py --classes clinical_leprosy microscopy_chagas --batch_size 16 --nets efficientnet_b3 --epochs 1 --num_workers 0 --use_single_gpu"